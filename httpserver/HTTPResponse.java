...
public class HTTPResponse {
	...
	public HTTPResponse(Socket socket, HTTPHandler handler) throws IOException, HTTPException {
	...
	public void respond() throws IOException, HTTPException {
		 ...
		 */
		if (getHandler().getRequest().getRequestType().equals(HTTPRequest.HEAD_REQUEST_TYPE) || getHandler().getResponseCode() == 204) {
			return;
		}
